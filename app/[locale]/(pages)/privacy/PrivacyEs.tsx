...
export function PrivacyEs() {
  return (
    <>
      ...
      <p>
        Esta política de privacidad explica cómo Javier Norberto Zader ("yo", "mi", "este sitio")
        recopila, usa y protege tu información personal cuando usas este sitio web.
      </p>
      <p>
        Me comprometo a proteger tu privacidad y cumplir con la Ley 25.326 de Protección de Datos
        Personales de Argentina, así como con el Reglamento General de Protección de Datos (GDPR) de
        la Unión Europea para visitantes de la UE.
      </p>
      ...
      <ul>
        <li>
          <strong>Newsletter:</strong> Email, fecha de suscripción, preferencias de consentimiento
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <strong>Analytics:</strong> Páginas visitadas, tiempo de permanencia (solo si autorizas
      ...
      <ul>
        <li>
          <strong>Newsletter:</strong> Enviarte emails con contenido y actualizaciones (solo con tu
        ...
        <li>
          <strong>Mejorar el sitio:</strong> Analizar el uso del sitio para mejorar la experiencia
          (si autorizas cookies de analytics)
        </li>
        <li>
      ...
      <div className="bg-[var(--color-primary)]/10 border border-[var(--color-primary)] rounded-lg p-6 my-6">
        ...
        <ul className="mb-0">
          ...
          <li>
            <strong>Derecho a Retirar Consentimiento:</strong> En cualquier momento sin afectar la
      ...
      <div className="mb-4">
        ...
        <Link href="/data-request">página de solicitud de datos</Link> o contacta a {email}
      </div>

      <h2>8. Retención de Datos</h2>
      <ul>
        <li>
          <strong>Newsletter:</strong> Hasta que canceles la suscripción + 30 días (para procesar la
          baja)
        </li>
        <li>
      ...
      <p>
        Tus datos pueden ser procesados en servidores fuera de Argentina. Los proveedores utilizados
        cumplen con estándares de protección de datos:
      </p>
      <ul>
        <li>
      ...
      <p>
        Este sitio no está dirigido a menores de 13 años. No recopilo intencionalmente información
        de menores. Si descubro que he recopilado datos de un menor, los eliminaré inmediatamente.
      </p>

      <h2>12. Cambios en esta Política</h2>
      <p>
        Puedo actualizar esta política ocasionalmente. Te notificaré de cambios importantes por
        email (si estás suscrito) o mediante un aviso en el sitio. La versión actual siempre estará
